...
export default function Main() {
  return (
    ...
    <form className="cont-input">
        <p className="txt-wannabe">나는 <input type="text" placeholder="프로그래밍"/>전문가가 될 것이다.</p>
    ...
    <section className="cont-result">
        ...
        <p className="txt-wannabe">당신은 <strong>프로그래밍</strong> 전문가가 되기 위해서<br /> 대략 <strong>1000일</strong> 이상 훈련하셔야 합니다.</p>
